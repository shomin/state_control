...
b_step={b_key,@n_plus,1};

zero = {@zero_thrust,gains,@n_no,1, spacebar,@n_plus,1};
hover={@xyz_hover, gains, [],@n_no,1, spacebar,@n_plus,1};


states = [...
    create_state(zero{:});...
    create_state(@xyz_vel, gains, start+[0 0 .3 0], speed,accel,@n_plus,1, b_step{:});...
    create_state(@xyz_hover, gains, start+[0 0 .3 0],@n_no,1, spacebar,@n_plus,1);...
    create_state(@xyz_vel, gains, start+[1 -.6 .3 0], speed,accel,@n_plus,1, b_step{:});...
    create_state(hover{:});...
    create_state(@xyz_traj, tgains, traj,@n_plus,1, b_step{:});...
    create_state(hover{:});...
    create_state(@xyz_vel, gains, start+[0 0 .3 0], speed,accel,@n_plus,1, b_step{:});...
    create_state(hover{:},button_press,@n_minus,3);...
